...
function Signup() {
  ...
  return (
    <div className="page-container">
      <form className="form_container" onSubmit={handleSubmit(signupHandler)}>
        ...
        <div className="title_container">
          ...
          <span className="subtitle">
            Join us today! Sign up to start using the app and enjoy all the
            features.
          </span>
        </div>
        <br />
        <div className="input_container">
          <label className="input_label" htmlFor="firstname_field">
            First Name
          </label>
          <svg
...
const GetAuthenticationAppCode = () => {
  return (
    <div className="get-authentication-app-code">
      <div className="authentication-app-hedaing">
        <span>{fullName} • NamasteApp</span>
        <span>Get your code from your authentication app</span>
...
const successAuthenticationApp = () => {
  return (
    <div className="success-authentication-app">
      <div className="success-authentication-app-heading">
        <span>{fullName} • NamasteApp</span>
        ...
        <p>
          See your list of <button>backup codes</button>
        </p>
      </div>
      <button>Done</button>
    </div>
